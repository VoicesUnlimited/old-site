...
$subject = 'Poll Studieweekend';          // Subject of email sent to you.
$emailadd = 'studieweekend@live.nl';    // Recipient email address. This is where the form information will be sent.
$emailfrom = 'webmaster@voicesunlimited.nl';     // Your email address. This is the 'from' address
$url = 'http://www.voicesunlimited.nl/ledenvoices/dank.htm'; // Where to redirect after form is processed.
...
if ($auth) {
  $text = "Resultaten van de studieweekend-poll:\n\n";
  $space = '  ';
  $line = '
  ';
  foreach ($_POST as $key => $value)
  {
    ...
    $value = str_replace('\n', "$line", $value);
    $conc = "{$key}$space:$space{$value}$line\n";
    $text .= $conc;
    $space = '  ';
  }
